...
void Scene::init(unsigned int level)
{
	...
	if (menu) l.back()->init(texProgram, glm::ivec2(320, 320), glm::ivec2(-4, 0), glm::ivec2(48,40), l.back() -> BLUE);
	else l.back()->init(texProgram, glm::ivec2(320, 120), glm::ivec2(-4, 0), glm::ivec2(48, 40), l.back()->BLUE);
...
void Scene::update(int deltaTime)
{
	...
	while (it != l.end()) {
		...
		if (player -> hook_test(bub -> getPosition(), bub -> getSize()) ) {
